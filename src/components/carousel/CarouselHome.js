      ...
      <div className="bg-gradient-to-r from-sky-400 to-blue-500 h-80 rounded-md " >
        <div className="container px-3">
          <div className="flex justify-between ">
            <div className="text-white w-2/5 my-10 hidden md:block">
              ...
              <button className="px-5 py-3 border-2 border-white hover:bg-white hover:text-sky-500 rounded-2xl mt-5 font-bold hidden lg:inline">Xem chi tiết</button>
            </div>
            <img src="../img/banner1.png" alt="" className="w-full md:w-2/5   object-cover opacity-70" />
          </div>
        </div>
      </div>
      <div className="bg-gradient-to-bl from-sky-400 to-blue-500 h-80 rounded-md ">
        <div className="container px-3">
          <div className="flex justify-between ">
            ...
            <img src="../img/banner4.png" alt="" className="w-full md:w-2/5    object-cover opacity-70" />
          </div>
        </div>
      </div>
      <div className="bg-gradient-to-br from-sky-400 to-blue-500 h-80 rounded-md">
        <div className="container px-3">
          <div className="flex justify-between">
            ...
            <img src="../img/banner5.png" alt="" className="w-full md:w-2/5  object-cover opacity-70 " />
          </div>
        </div>
      </div>
    </Carousel>
